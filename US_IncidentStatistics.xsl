...
<root>
	<VersionInfo>
		<Filename>US_IncidentStatistics.xml</Filename>
		...
		<BuildTime>2018/07/21 22:08:11</BuildTime>
	</VersionInfo>
	...
	<!-- Parameters from the dynamic DW parameter window -->
	...
	<SQLParameter>ESAreaLevel1</SQLParameter>
	<SQLParameter>ESAreaLevel2</SQLParameter>
	<SQLParameter>ESAreaLevel3</SQLParameter>
	<SQLParameter>ESAreaLevel4</SQLParameter>
	...
	<SQLParameter>ORI</SQLParameter>
	<SQLParameter>OccurrenceStatus</SQLParameter>
	<SQLParameter>GOccIvPAClassification</SQLParameter>
	<SQLParameter>AddressClassification</SQLParameter>
	...
	<SQLSelectXSLT><![CDATA[<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
				...
				<xsl:param name="ESAreaLevel1" />
				<xsl:param name="ESAreaLevel2" />
				<xsl:param name="ESAreaLevel3" />
				<xsl:param name="ESAreaLevel4" />
				...
				<xsl:param name="GOccIvPAClassification" />
				<xsl:param name="AddressClassification" />
				<xsl:param name="OccurrenceTypeRId" />
				<xsl:param name="OccurrenceClassification" />
				<xsl:param name="OffenseTypeRId" />
				...
				<xsl:template match="/">
					----------------------------------------------------------
					--  XML filename: US_IncidentStatistics.xml
					--  File revision: 1.13
					...
					SELECT
						...
						Occurrence__ESAreaLevel4G,
						Occurrence__ESAreaLevel3G,
						Occurrence__ESAreaLevel2G,
						Occurrence__ESAreaLevel1G,
						...
						PhysicalAddress__ClassificationG,

						NIBRSIncident__ORI,
						USStatsClassification__Id,
						USStatsClassificationOffense__USStatsOffenseStdClassOffenseRId_L
					...
					<xsl:if test="$StartTime = '' or $EndTime = ''">
						<xsl:message terminate="yes">ERROR:  You must provide incident start and end times.
						</xsl:message>
					</xsl:if>

					MakeInterval(Occurrence.StartTimeTZV2I, Occurrence.EndTimeTZV2I, '[]', 'NullCollapses')
							= MakeInterval(
						...
						<xsl:if test="$OfficerRId">
							AND GOccInvGPerson.RId = <xsl:call-template name="StuffSQL"><xsl:with-param name="ToStuff" select="$OfficerRId" /></xsl:call-template>
						</xsl:if>

						<xsl:if test="$OfficerClassification">
							AND
							<xsl:call-template name="CreateConditionFromSet">
								<xsl:with-param name="FieldName">Officer.Classification</xsl:with-param>
								<xsl:with-param name="FieldValue" select="$OfficerClassification" />
						...
						<xsl:if test="$ORI">
							...
							<xsl:call-template name="MultiValueField">
								<xsl:with-param name="FormField"><xsl:value-of select="$ORI" /></xsl:with-param>
								<xsl:with-param name="DBField">NIBRSIncident.ORI</xsl:with-param>
							</xsl:call-template>
						</xsl:if>
						...
						<xsl:if test="$OccurrenceStatus">
							...
							<xsl:call-template name="CreateConditionFromSet">
								...
								<xsl:with-param name="FieldValue" select="$OccurrenceStatus" />
							</xsl:call-template>
						</xsl:if>

						<xsl:if test="$GOccIvPAClassification">
							AND
							<xsl:call-template name="CreateConditionFromSet">
								<xsl:with-param name="FieldName">GOccIvPA.Classification</xsl:with-param>
								<xsl:with-param name="FieldValue" select="$GOccIvPAClassification" />
								<xsl:with-param name="IsSetField">1</xsl:with-param>
							</xsl:call-template>
						</xsl:if>

						<xsl:if test="$AddressClassification">
							AND
							<xsl:call-template name="CreateConditionFromSet">
								<xsl:with-param name="FieldName">PhysicalAddress.Classification</xsl:with-param>
								<xsl:with-param name="FieldValue" select="$AddressClassification" />
								<xsl:with-param name="IsSetField">1</xsl:with-param>
							</xsl:call-template>
						</xsl:if>

						<xsl:if test="$OccurrenceTypeRId">
							AND Occurrence.OccurrenceStdOccTypeRId = <xsl:call-template name="StuffSQL"><xsl:with-param name="ToStuff" select="$OccurrenceTypeRId" /></xsl:call-template>
						</xsl:if>

						<xsl:if test="$OccurrenceClassification">
							AND
							<xsl:call-template name="CreateConditionFromSet">
								<xsl:with-param name="FieldName">Occurrence.Classification</xsl:with-param>
								<xsl:with-param name="FieldValue" select="$OccurrenceClassification" />
								<xsl:with-param name="IsSetField">1</xsl:with-param>
							</xsl:call-template>
						</xsl:if>

						<xsl:if test="$OffenseTypeRId">
							AND USStatsClassificationOffense.USStatsOffenseStdClassOffenseRId = <xsl:call-template name="StuffSQL"><xsl:with-param name="ToStuff" select="$OffenseTypeRId" /></xsl:call-template>
						</xsl:if>
						...
						<xsl:if test="$ESAreaLevel6">
							AND
							<xsl:call-template name="MultiValueField">
								<xsl:with-param name="FormField"><xsl:value-of select="$ESAreaLevel6" /></xsl:with-param>
						...
						<xsl:if test="$ESAreaLevel5">
							AND
							<xsl:call-template name="MultiValueField">
								<xsl:with-param name="FormField"><xsl:value-of select="$ESAreaLevel5" /></xsl:with-param>
								<xsl:with-param name="DBField">Occurrence.ESAreaLevel5</xsl:with-param>
							</xsl:call-template>
						</xsl:if>
						<xsl:if test="$ESAreaLevel4">
							AND
							<xsl:call-template name="MultiValueField">
								<xsl:with-param name="FormField"><xsl:value-of select="$ESAreaLevel4" /></xsl:with-param>
								<xsl:with-param name="DBField">Occurrence.ESAreaLevel4</xsl:with-param>
							</xsl:call-template>
						</xsl:if>
						<xsl:if test="$ESAreaLevel3">
							AND
							<xsl:call-template name="MultiValueField">
								<xsl:with-param name="FormField"><xsl:value-of select="$ESAreaLevel3" /></xsl:with-param>
								<xsl:with-param name="DBField">Occurrence.ESAreaLevel3</xsl:with-param>
							</xsl:call-template>
						</xsl:if>
						<xsl:if test="$ESAreaLevel2">
							AND
							<xsl:call-template name="MultiValueField">
								<xsl:with-param name="FormField"><xsl:value-of select="$ESAreaLevel2" /></xsl:with-param>
								<xsl:with-param name="DBField">Occurrence.ESAreaLevel2</xsl:with-param>
							</xsl:call-template>
						</xsl:if>
						<xsl:if test="$ESAreaLevel1">
							AND
							<xsl:call-template name="MultiValueField">
								<xsl:with-param name="FormField"><xsl:value-of select="$ESAreaLevel1" /></xsl:with-param>
								<xsl:with-param name="DBField">Occurrence.ESAreaLevel1</xsl:with-param>
							</xsl:call-template>
						</xsl:if>

						AND Occurrence.ACCDomain = <xsl:call-template name="StuffSQL"><xsl:with-param name="ToStuff" select="$ACCDomain" /></xsl:call-template>
					...
					<HTML>
						...
						<xsl:element name="BODY">
							...
							<TABLE>
								...
								<xsl:for-each select="/DATASETLIST/DATASET/ROW[Occurrence__ACCDomain]">
									<TR>
										<TD class="TableData"><xsl:value-of select="Occurrence__ACCDomain" /></TD>
										<TD class="TableData"><xsl:value-of select="Occurrence__StartTimeTZV2G" /></TD>
										<TD class="TableData"><xsl:value-of select="Occurrence__ESAreaLevel6G" /></TD>
										<TD class="TableData"><xsl:value-of select="Occurrence__ESAreaLevel5G" /></TD>
										<TD class="TableData"><xsl:value-of select="Occurrence__ESAreaLevel4G" /></TD>
										<TD class="TableData"><xsl:value-of select="Occurrence__ESAreaLevel3G" /></TD>
										<TD class="TableData"><xsl:value-of select="Occurrence__ESAreaLevel2G" /></TD>
										<TD class="TableData"><xsl:value-of select="Occurrence__ESAreaLevel1G" /></TD>
										<TD class="TableData"><xsl:value-of select="GOccInvGPerson__LabelRight" /></TD>
										<TD class="TableData"><xsl:value-of select="NIBRSIncident__ORI" /></TD>
										<TD class="TableData"><xsl:value-of select="Occurrence__UCRClearanceStatus" /></TD>
										<TD class="TableData"><xsl:value-of select="GOccIvPA__ClassificationG" /></TD>
										<TD class="TableData"><xsl:value-of select="PhysicalAddress__ClassificationG" /></TD>
										<TD class="TableData"><xsl:value-of select="Occurrence__OccurrenceStdOccTypeRId_L" /></TD>
										<TD class="TableData"><xsl:value-of select="Occurrence__ClassificationG" /></TD>
										<TD class="TableData"><xsl:value-of select="USStatsClassificationOffense__USStatsOffenseStdClassOffenseRId_L" /></TD>
										<TD class="TableData"><xsl:value-of select="Occurrence__OccurrenceFileNoG" /></TD>
									</TR>
								</xsl:for-each>
							</TABLE>
	...
	<USLReportParameters>
		<DSL>
			<Metadata>
				<ChoiceList Name="cl_bool">
					<Choice DBValue="0" GUIValue="0" />
					<Choice DBValue="1" GUIValue="1" />
				</ChoiceList>
				<ChoiceList Name="cl_accdomain">
					<Choice DBValue="Current" GUIValue="Domain" />
					<Choice DBValue="Current+" GUIValue="Domain and subdomains" />
				</ChoiceList>
				<Entity Name="Parameters">
					...
					<Field Name="ESAREALEVEL6G" BehaveLike="PhysicalAddress.ESAreaLevel6G" />
					<Field Name="ESAREALEVEL5G" BehaveLike="PhysicalAddress.ESAreaLevel5G" />
					<Field Name="ESAREALEVEL4G" BehaveLike="PhysicalAddress.ESAreaLevel4G" />
					<Field Name="ESAREALEVEL3G" BehaveLike="PhysicalAddress.ESAreaLevel3G" />
					<Field Name="ESAREALEVEL2G" BehaveLike="PhysicalAddress.ESAreaLevel2G" />
					<Field Name="ESAREALEVEL1G" BehaveLike="PhysicalAddress.ESAreaLevel1G" />


					<Field Name="OfficerRId" />
					<Field Name="OfficerRId_L">
						<Selector ColumnHelpFields="OfficerRId=Id;OfficerRId_L=Label" ColumnHelp="SpecificationKey=d_gpersonemploylist;Title=Officer selector;Text1=1. Enter officer's badge number or name.;Text2=. Select officer from list.;Condition=ACCDomain=='Current-' AND Indexed==1 AND IsEmployee==1" />
					</Field>
					<SetField Name="OfficerClassification" ChoiceListName="cl_PersonClassification" ChoiceListSource="NML" />

					<Field Name="ORI" BehaveLike="NIBRSIncident.ORI" />

					<SetField Name="OccurrenceStatusInternal" ChoiceListName="cl_UCRIncidentClearanceStatus" ChoiceListSource="NML" />
					<SetField Name="GOccIvPAClassification" ChoiceListName="cl_GOccIvPAClassification" ChoiceListSource="NML" />
					<SetField Name="AddressClassification" ChoiceListName="cl_PhysicalAddressClassification" ChoiceListSource="NML" />

					<Field Name="OccurrenceTypeRId_L">
						<Selector ColumnHelpFields="OccurrenceTypeRId=Id;OccurrenceTypeRId_L=Label" ColumnHelp="SpecificationKey=d_StandardOccurrenceTypeLabel;Title=Standard Incident Type Selector;Text1=1. Enter all or part of an Incident Type.;Text2=2. Select Incident Type from list.;Condition=ACCDomain=='Current-' AND MakeInterval(EffectiveFromTimeTZV2I, EffectiveToTimeTZV2I, '[]', 'NullIsInfinite')=='now';DateRestrictedCondition=ACCDomain=='Current-' AND ((EffectiveToTimeTZV2I IS NULL OR EffectiveToTimeTZV2I &gt; '{0}') AND (EffectiveFromTimeTZV2I IS NULL OR EffectiveFromTimeTZV2I &lt; '{0}') AND AnyOfSetHasProperty(Properties, 'cl_StandardOccurrenceTypeProperties', 'clvIsOffenseNoticeOcc', '1')==1)" />

					</Field>
					<Field Name="OccurrenceTypeRId" BehaveLike="Occurrence.OccurrenceStdOccTypeRId" />


					<SetField Name="OccurrenceClassification" ChoiceListName="cl_OccurrenceClassification" ChoiceListSource="NML" />

					<Field Name="OffenseTypeRId_L">
						<Selector ColumnHelpFields="OffenseTypeRId=Id;OffenseTypeRId_L=Label" ColumnHelp="SpecificationKey=scs_StandardUSStatsClassificationOffense;Title=Offense code selector;Text1=1. Enter all or part of an offense code;Text2=2. Select offense code from list.;Condition=ACCDomain=='Current-';DateRestrictedCondition=ACCDomain=='Current-' AND ((EffectiveToTimeTZV2I IS NULL OR EffectiveToTimeTZV2I &gt; '{0}') AND (EffectiveFromTimeTZV2I IS NULL OR EffectiveFromTimeTZV2I &lt; '{0}')" />
					</Field>
					<Field Name="OffenseTypeRId" BehaveLike="USStatsClassificationOffense.USStatsOffenseStdClassOffenseRId" />

					<Field Name="Charges" />

					<Field Name="AccDomainG" />
					<BoolField Name="UseReportServer" ChoiceListName="cl_bool" />
			...
			<Entity Name="Parameters" DSLBased="True">
				...
				<Field Name="ESAREALEVEL6G" ExportName="ESAreaLevel6" ExportType="DisplayValue" />
				<Field Name="ESAREALEVEL5G" ExportName="ESAreaLevel5" ExportType="DisplayValue" />
				<Field Name="ESAREALEVEL4G" ExportName="ESAreaLevel4" ExportType="DisplayValue" />
				<Field Name="ESAREALEVEL3G" ExportName="ESAreaLevel3" ExportType="DisplayValue" />
				<Field Name="ESAREALEVEL2G" ExportName="ESAreaLevel2" ExportType="DisplayValue" />
				<Field Name="ESAREALEVEL1G" ExportName="ESAreaLevel1" ExportType="DisplayValue" />

				<Field Name="OfficerRId" ExportName="OfficerRId" ExportType="StorableValue" />
				<Field Name="OfficerRId_L" ExportName="OfficerRId_L" ExportType="DisplayValue" />

				<Field Name="ORI" ExportName="ORI" ExportType="DisplayValue" />
				<Field Name="OfficerClassificationG" ExportName="OfficerClassification" ExportType="StorableValue" />
				<Field Name="OccurrenceStatusInternalG" ExportName="OccurrenceStatus" ExportType="StorableValue" />
				<Field Name="GOccIvPAClassificationG" ExportName="GOccIvPAClassification" ExportType="StorableValue" />
				<Field Name="AddressClassificationG" ExportName="AddressClassification" ExportType="StorableValue" />

				<Field Name="OccurrenceTypeRId" ExportName="OccurrenceTypeRId" ExportType="StorableValue" />
				<Field Name="OccurrenceTypeRId_L" ExportName="OccurrenceTypeRId_L" ExportType="DisplayValue" />

				<Field Name="OccurrenceClassificationG" ExportName="OccurrenceClassification" ExportType="StorableValue" />

				<Field Name="OffenseTypeRId" ExportName="OffenseTypeRId" ExportType="StorableValue" />
				<Field Name="OffenseTypeRId_L" ExportName="OffenseTypeRId_L" ExportType="DisplayValue" />

				<Field Name="AccDomainG" ExportName="ACCDomain" ExportType="DisplayValue" />
				<Field Name="UseReportServerG" ExportName="UseReportServer" ExportType="StorableValue" />
		...
		<Data>
			<Node Name="Parameters" DSLBased="true">
				...
				<Cell Name="ESAREALEVEL4G" />
				<Cell Name="ESAREALEVEL3G" />
				<Cell Name="ESAREALEVEL2G" />
				<Cell Name="ESAREALEVEL1G" />

				<Cell Name="OfficerRId" />
				<Cell Name="OfficerRId_L" />

				<Cell Name="ORI" />
				<Cell Name="OfficerClassificationG" Value="" />
				<Cell Name="OccurrenceStatusInternalG" />
				<Cell Name="GOccIvPAClassificationG" />
				<Cell Name="AddressClassificationG" />
				<Cell Name="OccurrenceTypeRId" />
				<Cell Name="OccurrenceTypeRId_L" />
				<Cell Name="OccurrenceClassificationG" />
				<Cell Name="OffenseTypeRId" />
				<Cell Name="OffenseTypeRId_L" />

				<Cell Name="AccDomainG" Value="" />
				<Cell Name="UseReportServerG" Value="0" />
			...
			<![CDATA[
				view AnalysisOfCaseLoad
				{
					...
					flowGrid(maxColumns: 2, content: {
						...
						column (content: nmlFieldControl(labelKey: 'FL:PhysicalAddress:ESAreaLevel4G', fieldName: 'ESAREALEVEL4G', visibility: nmlFieldVisibility ('PhysicalAddress', 'ESAreaLevel4')))
						...
						column (content: nmlFieldControl(labelKey: 'FL:PhysicalAddress:ESAreaLevel2G', fieldName: 'ESAREALEVEL2G', visibility: nmlFieldVisibility ('PhysicalAddress', 'ESAreaLevel2')))
						column (content: nmlFieldControl(labelKey: 'FL:PhysicalAddress:ESAreaLevel1G', fieldName: 'ESAREALEVEL1G', visibility: nmlFieldVisibility ('PhysicalAddress', 'ESAreaLevel1')))
						...
						column(content: nmlFieldControl(labelText: 'ORI', fieldName: 'ORI'))
						column(content: nmlFieldControl(labelText: 'Incident status', fieldName: 'OccurrenceStatusInternalG'))
						column(content: nmlFieldControl(labelText: 'Location classification', fieldName: 'GOccIvPAClassificationG'))
						column(content: nmlFieldControl(labelText: 'Site classification', fieldName: 'AddressClassificationG'))
						...
						column(content: nmlFieldControl(labelText: 'Include NIBRS offenses', fieldName: 'OffenseTypeRId_L'))
	...
	<DatawindowDef>
		<![CDATA[
			...
			declare ESAreaLevel1 edit			{ tag = "EntityName=PhysicalAddress;FieldName=ESAreaLevel1;AllowMultiValues=1"; size = 50; label = "Point:"; };
			declare ESAreaLevel2 edit			{ tag = "EntityName=PhysicalAddress;FieldName=ESAreaLevel2;AllowMultiValues=1"; size = 50; label = "Place:"; };
			declare ESAreaLevel3 edit			{ tag = "EntityName=PhysicalAddress;FieldName=ESAreaLevel3;AllowMultiValues=1"; size = 50; label = "Site:"; };
			declare ESAreaLevel4 edit			{ tag = "EntityName=PhysicalAddress;FieldName=ESAreaLevel4;AllowMultiValues=1"; size = 50; label = "Area:"; };
			...
			declare ORI edit					{ label="ORI:"; };

			declare OccurrenceStatusInternal set{ tag = "EntityName=Occurrence;FieldName=UCRClearanceStatusG"; label = "Incident status:"; };
			declare GOccIvPAClassification set	{ tag = "EntityName=GOccIvPA;FieldName=ClassificationG"; label = "Location classification"; };
			declare AddressClassification set	{ tag = "EntityName=PhysicalAddress;FieldName=ClassificationG"; label = "Site classification:"; };
			...
			declare OffenseTypeRId_L edit		{ tag = "EntityName=USStatsClassificationOffense;FieldName=USStatsOffenseStdClassOffenseRId_L"; label = "Include NIBRS offenses:"; };
			declare OffenseTypeRId edit			{ tag = "EntityName=USStatsClassificationOffense;FieldName=USStatsOffenseStdClassOffenseRId"; };

			declare Charges edit				{ label = "Charges:"; };
			...
			datawindowdef ParameterWindow "ParameterWindow"
			{
				...
				field GOccIvPAClassification;
				field AddressClassification;
				...
				field OffenseTypeRId_L;
				field OffenseTypeRId { visible = false; property CreateControlOnDW = "1"; };
				field Charges;
